...
Sign up at [app.reader.dev](https://app.reader.dev) (free tier: 1,000 credits/month, no card). Copy your API key from the dashboard; it starts with `rdr_`.
...
- `metadata.proxyMode`: which mode actually ran. See [Proxy modes](/home/concepts/proxy-modes).
