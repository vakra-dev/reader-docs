...
Each entry in the pool is a Chrome instance managed by Playwright:

- A running headless Chrome process (spawned via `child_process.spawn`)
- A Playwright connection over CDP for scripting it
