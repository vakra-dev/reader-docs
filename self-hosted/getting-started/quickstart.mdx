...
3. **Playwright engine** - Reader renders the page in headless Chrome with JavaScript execution and proxy routing. If the first attempt fails, it escalates to a residential proxy automatically.
