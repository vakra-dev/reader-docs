...
A batch of N URLs in `standard` mode costs exactly N credits. In `premium` mode it costs 3N credits. If you have a mixed batch, consider pre-splitting by site type. See [Cost estimation](/home/guides/production/cost-estimation) for how to pilot first.
