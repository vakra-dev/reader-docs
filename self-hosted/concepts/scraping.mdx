...
1. **Fetch** - Reader renders the page in a headless Chrome browser (Hero engine) with JavaScript execution, TLS fingerprinting, and proxy routing. See [Scraping Engine](/self-hosted/concepts/engine-waterfall).
